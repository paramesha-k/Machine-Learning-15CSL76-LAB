...
df_tennis = DataFrame.from_csv(r"C:\Users\Administrator\PycharmProjects\candidateelimination\golf.csv")
print(df_tennis)
...
train=df_tennis.sample(frac=0.8,random_state=100) #random state is a seed value
test=df_tennis.drop(train.index)
